...
- Canvas snapshots stored as Vercel Blob artifacts with database references.
...
- Specs are persisted as Vercel Blob artifacts and linked to the project in the database.
